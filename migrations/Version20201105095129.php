 ...
 */
final class Version20201105095129 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE employe (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, salaire NUMERIC(9, 2) NOT NULL, idLieu INT NOT NULL, INDEX IDX_F804D3B95CAA23C7 (idLieu), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
